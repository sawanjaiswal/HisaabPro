/**
 * One-shot migration helper: grant orders.* permissions to existing system roles.
 * Idempotent — safe to re-run; already-granted permissions are no-ops.
 *
 * Usage: npx tsx prisma/grant-orders-permission.ts
 */
...
const GRANTS: Record<string, string[]> = {
  Salesman:       ['orders.view', 'orders.create', 'orders.edit'],
  Cashier:        ['orders.view', 'orders.edit'],
  'Stock Manager': ['orders.view'],
