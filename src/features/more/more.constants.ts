...
export const MORE_MENU_ITEMS: MoreMenuItem[] = [
  ...
  { id: 'draft-invoices', navKey: 'draft-invoices', label: 'Draft Invoices', description: 'Invoices you started but did not save', icon: 'FileEdit', route: ROUTES.INVOICE_DRAFTS, color: 'var(--color-primary-50)', group: 'money' },
  ...
  { id: 'bank-reconciliation', navKey: 'bank-reconciliation', label: 'Bank Reconciliation', description: 'Match statement to payments', icon: 'Landmark', route: ROUTES.BANK_RECONCILIATION, color: 'var(--color-primary-50)', group: 'accounting' },
  ...
  { id: 'stock-adjustments', navKey: 'stock-adjustments', label: 'Stock Adjustment', description: 'Manual stock corrections log', icon: 'SlidersHorizontal', route: ROUTES.STOCK_ADJUSTMENTS, color: 'var(--color-secondary-50)', group: 'accounting' },
