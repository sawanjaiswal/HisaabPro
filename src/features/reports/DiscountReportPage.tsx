...
export default function DiscountReportPage() {
  ...
  if (fetchStatus === 'error') {
    return (
      <AppShell>
        <Header title={t.discountReport} backTo={ROUTES.REPORTS} />
        <PageContainer variant="list" className="space-y-6"><ErrorState title={t.couldNotLoadDiscountReport} message={t.checkConnectionRetry} onRetry={refresh} /></PageContainer>
      </AppShell>
    )
  }
