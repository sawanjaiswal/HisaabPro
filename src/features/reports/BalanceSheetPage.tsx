    ...
    <AppShell>
      ...
      <PageContainer variant="list" className="space-y-6">
        <div className="finance-date-bar fade-up">
          ...
          <DateField type="date" className="finance-date-bar__input" value={asOf} onChange={(e) => setAsOf(e.target.value)} aria-label={t.asOfDate} />
          <Button variant="none" type="button" className="finance-date-bar__refresh-btn" onClick={refresh} aria-label={t.refreshBalanceSheet}>
