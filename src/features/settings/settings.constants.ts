...
export const SETTINGS_SECTIONS: SettingsSection[] = [
  ...
  },
  {
    ...
    title: 'Display',
    items: [
      { id: 'theme', label: 'Dark Mode', description: 'Switch between light and dark appearance', icon: 'Moon', type: 'toggle' },
      { id: 'language', label: 'Language', description: 'Switch between English and Hindi', icon: 'Languages', type: 'select' },
      { id: 'date-format', label: 'Date Format', description: 'How dates are shown throughout the app', icon: 'Calendar', type: 'select' },
      ...
      { id: 'shortcuts', label: 'Keyboard Shortcuts', description: 'Speed up billing on tablet and desktop', icon: 'Keyboard', route: ROUTES.SETTINGS_SHORTCUTS, type: 'navigation' },
      { id: 'calculator-position', label: 'Calculator Position', description: 'Where the floating calculator button appears', icon: 'Calculator', type: 'select' },
    ],
  },
]
