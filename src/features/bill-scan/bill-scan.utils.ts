/** Bill Scanning / OCR — Pure utility functions
 *
 * Image preprocessing and OCR text parsing.
 * No hooks, no side effects.
 */

import type { ExtractedItem } from './bill-scan.types'
import { MAX_IMAGE_DIMENSION, MAX_EXTRACTED_ITEMS } from './bill-scan.constants'
