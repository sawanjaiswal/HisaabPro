    ...
    <div className="card product-info-card">
      {description && (
        <div className="product-info-row" style={{ flexDirection: 'column', alignItems: 'flex-start' }}>
          <span style={{ color: 'var(--color-gray-400)', fontSize: '0.875rem' }}>{t.descriptionLabel}</span>
          <p style={{ marginTop: 'var(--space-1)', lineHeight: 1.5 }}>{description}</p>
        </div>
      )}
      {hsnCode && (
        <div className="product-info-row">
          <span style={{ color: 'var(--color-gray-400)', fontSize: '0.875rem', minWidth: 100 }}>{t.hsnCodeLabel}</span>
          <span style={{ fontWeight: 500 }}>{hsnCode}</span>
        </div>
      )}
      {sacCode && (
        <div className="product-info-row">
          <span style={{ color: 'var(--color-gray-400)', fontSize: '0.875rem', minWidth: 100 }}>{t.sacCodeLabel}</span>
          <span style={{ fontWeight: 500 }}>{sacCode}</span>
        </div>
      )}
      <div className="product-info-row">
        <span style={{ color: 'var(--color-gray-400)', fontSize: '0.875rem', minWidth: 100 }}>{t.skuLabel}</span>
      ...
      <div className="product-info-row">
        <span style={{ color: 'var(--color-gray-400)', fontSize: '0.875rem', minWidth: 100 }}>{t.statusLabel}</span>
