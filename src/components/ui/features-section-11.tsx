...
/* Lightweight card primitives (self-contained, no shadcn dependency) */
function SCard({ className = '', children, ...props }: HTMLAttributes<HTMLDivElement>) {
    return (
...
function SCardHeader({ className = '', children, ...props }: HTMLAttributes<HTMLDivElement>) {
    return (
...
function SCardContent({ className = '', children, ...props }: HTMLAttributes<HTMLDivElement>) {
    return (
...
export function FeaturesSection11() {
    return (
        <section className="dark:bg-muted/25 bg-zinc-50 py-16 md:py-32">
            <div className="mx-auto max-w-5xl px-6">
                <div className="mx-auto grid gap-2 sm:grid-cols-5">
                    <SCard className="group overflow-hidden shadow-black/5 sm:col-span-3 sm:rounded-none sm:rounded-tl-xl">
                        <SCardHeader>
                    ...
                    <SCard className="group overflow-hidden shadow-zinc-950/5 sm:col-span-2 sm:rounded-none sm:rounded-tr-xl">
                        ...
                        <SCardContent className="mt-auto h-fit">
                    ...
                    <SCard className="group p-6 shadow-black/5 sm:col-span-2 sm:rounded-none sm:rounded-bl-xl md:p-12">
                    ...
                    <SCard className="group relative shadow-black/5 sm:col-span-3 sm:rounded-none sm:rounded-br-xl">
                        <SCardHeader className="p-6 md:p-12">
                            <p className="font-medium">Advanced tracking system</p>
                            <p className="text-muted-foreground mt-2 max-w-sm text-sm">Quick AI lives a single hotkey away apps..</p>
                        </SCardHeader>
                        <SCardContent className="relative h-fit px-6 pb-6 md:px-12 md:pb-12">
