...
export const enExt20 = {
  ...
  cashRegToastErrorRestore:     'Could not restore entry.',
  cashRegToastErrorVoid:        'Could not void entry.',
  cashRegToastErrorDelete:      'Could not delete entry.',
  cashRegTabsAria:              'Cash register tabs',
  cashRegCommitAria:            'Commit cash entry',
  cashRegDisplayAria:           'Calculator display',
  cashRegKeypadAria:            'Calculator keypad',
  cashRegFilterDirAria:         'Filter by direction',
  cashRegSortAria:              'Sort entries',
  cashRegEntryActionsAria:      'Entry actions',
  cashRegLast7Aria:             'Last 7 days cash flow',
  cashRegLoadingEntries:        'Loading cash entries',
  cashRegLoadingMore:           'Loading more entries',
  cashRegSummaryLast30:         'Last 30 Days',
  cashRegErrorTooLong:          'Expression too long',
  cashRegErrorInvalidChar:      'Invalid character',
  cashRegErrorInvalidResult:    'Amount must be greater than 0',
  cashRegErrorOverflow:         'Amount exceeds ₹10 crore limit',
  cashRegMenuVoid:              'Void',
  cashRegMenuRestore:           'Restore',
  cashRegKeyClear:              'Clear',
  cashRegKeyBackspace:          'Backspace',
  cashRegKeyAdd:                'Add',
  cashRegKeySubtract:           'Subtract',
  cashRegKeyMultiply:           'Multiply',
  cashRegKeyDivide:             'Divide',
  cashRegKeyDecimal:            'Decimal point',
  cashRegCharsLeft:             'chars left',
  cashRegVoiding:               'Voiding…',
  cashRegVoidReasonPlaceholder: 'e.g. entered by mistake',
  cashRegLargeAmountPrefix:     'Amount is',
  cashRegConfirmQuestion:       'Confirm?',
}
